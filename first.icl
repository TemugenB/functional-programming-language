...
//Start = st "Hello" " World!" " form FP class"  // "Hello World! form FP class"
...
//Start = (div 5, divr 5.0, div 10, divr 10.0) // (2,2.5,5,5.5)
...
//Start = divbr 5 3  // 1.66666666666667
...
//Start = iseven 23  // False   isEven - built-in 


iseven2 :: Int -> Bool
iseven2 a = (a/2)*2 == a

//Start = iseven2 23 // False
...
//Start = granma 5.0 7.0 10.0  // 9605
...
// eq x = x^4 + 3*x^3 + 4*x^2 + x - 10  
// the value of the polinomial equation for x=10  eq x = 10?
...
// 200 + 20 + 22 + 24.2 + 26.62 + 29.28 + 32.21 = 354.3122
